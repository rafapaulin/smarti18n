...
export class Smarti18nPipe implements PipeTransform, OnDestroy {
	...
	/**
	 * Localizes the input
	 * @param value dot notation localizable path
	 * @param vars ```Key:Value``` pairs object for localized interpolation
	 * @param count Value to be taken in account in the pluralization process
	 ...
	 * @param vars ```Key:Value``` pairs object for localized interpolation.
	 * @returns True if there is any change do the value of the properties.
	 * @memberof Smarti18nPipe
	 */
